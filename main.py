...
def send_verification():
    ...
    msg = Message("Подтверждение Вашего аккаунта", recipients=[user.email])
    msg.body = f"Здравствуйте, {user.username}!\nВам пришел код подтверждения {verification_code}.\nЕсли Вы не регистрировались на StarTwi, " \
               f"то проигнорируйте, пожалуйста, это письмо.\nС уважением, \n\n техподдержка StarTwi"
    mail.send(msg)
